    ...
    <div className="p-4 sm:p-6 space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium text-primary-foreground bg-primary rounded-xl hover:bg-primary/90 shadow-sm shadow-primary/20 transition-colors shrink-0"
        >
          <Plus className="w-4 h-4" /> <span className="hidden sm:inline">Nova busca</span>
              ...
              <div key={b.id} className="bg-card border border-border/70 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                ...
                <div className="mt-3 space-y-2">
                  <div className="flex flex-wrap gap-2">
                    ...
                    {b.municipio_ibge && (
                      <span className="inline-flex items-center gap-1 text-xs bg-muted/60 px-2 py-1 rounded-md">
                        <Tag className="w-3 h-3 text-muted-foreground" /> IBGE: {b.municipio_ibge}
                      </span>
                    )}
                  </div>
