    ...
    <div className="flex flex-wrap items-center gap-2">
      {onSend && (
        <button
          ...
          className="inline-flex min-h-11 items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold text-slate-700 dark:text-slate-200 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 transition-colors"
        >
        ...
        <>
          {onTriagem && (
            <button
              ...
              className="inline-flex min-h-11 items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-bold text-status-blue-foreground bg-status-blue hover:bg-status-blue/90 shadow-xs transition-colors"
            >
