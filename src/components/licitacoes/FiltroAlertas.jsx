...
export default function FiltroAlertas({ alertas, filtroOrigem, setFiltroOrigem }) {
  ...
  return (
    <div className="relative flex-1 sm:flex-none min-w-0" ref={ref}>
      ...
      {aberto && (
        <div className="fixed inset-x-0 bottom-0 z-50 w-full bg-popover border-t rounded-t-2xl shadow-2xl max-h-[75vh] overflow-hidden flex flex-col sm:absolute sm:inset-auto sm:mt-1 sm:w-full sm:min-w-56 sm:rounded-lg sm:border sm:shadow-lg sm:max-h-64">
